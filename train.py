...
Original file is located at
    https://colab.research.google.com/drive/1snO8jQ1BGCuUy4YlOXBPtVLm_Nxzecw0
"""
...
filenames_train = tf.data.Dataset.list_files(root+"data/ShanghaiTechB/train_data/data-train*.tfrecords").shuffle(10).take(1)
filenames_valid = tf.data.Dataset.list_files(root+"data/ShanghaiTechB/train_data/data-valid*.tfrecords")
